  ...
  return (
    <div className={`fixed bottom-6 right-6 md:bottom-8 md:right-8 ${isOpen ? 'z-[9999]' : 'z-50'}`}>
      ...
      <div className="absolute bottom-0 right-0 flex flex-col items-end gap-4 pb-20 pointer-events-none">
        ...
        >
          <span className="bg-white/90 backdrop-blur-sm text-foreground text-[14px] font-bold px-3 py-1.5 rounded-lg shadow-sm border border-border whitespace-nowrap">Tư vấn viên AI</span>
          <button
            onClick={handleOpen}
        ...
        >
          <span className="bg-white/90 backdrop-blur-sm text-foreground text-[14px] font-bold px-3 py-1.5 rounded-lg shadow-sm border border-border whitespace-nowrap">Nhắn Zalo</span>
          <a
        ...
        >
          <span className="bg-white/90 backdrop-blur-sm text-foreground text-[14px] font-bold px-3 py-1.5 rounded-lg shadow-sm border border-border whitespace-nowrap">Gọi Hotline</span>
          <a
            href="tel:0123456789"
      ...
      {showTooltip && !isMenuOpen && !isOpen && (
        <div className="absolute bottom-16 right-0 z-[60] animate-in fade-in slide-in-from-bottom-2 duration-500 pointer-events-none mb-4">
          <div className="bg-white text-primary border border-primary/20 shadow-xl px-5 py-2.5 rounded-xl relative whitespace-nowrap">
            <p className="text-[14.5px] font-bold flex items-center gap-2">
      ...
      >
        ...
        <div className="bg-primary text-primary-foreground px-4 py-3 flex items-center justify-between shrink-0" style={{ paddingTop: 'max(0.75rem, env(safe-area-inset-top))' }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-base leading-tight">Daklink Assistant</h3>
              <p className="text-primary-foreground/70 text-[11px] flex items-center gap-1 mt-0.5">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#F8F8F7] scrollbar-hide">
          <div className="text-center py-2">
            <span className="text-[10px] uppercase font-bold text-muted-foreground/50 tracking-widest bg-muted px-3 py-1 rounded-full">
              Hôm nay
            </span>
          </div>
          ...
          {!hasUserSentMessage && !isLoading && (
            <div className="flex flex-col gap-2 pt-2 animate-in fade-in slide-in-from-bottom-3 duration-500">
              <div className="flex items-center gap-1.5 text-muted-foreground/60 mb-1">
                ...
                <span className="text-[11px] font-semibold uppercase tracking-wider">Gợi ý cho bạn</span>
              </div>
