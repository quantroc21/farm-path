    ...
    <div>
      ...
      <section className="px-5 py-6">
        <FadeIn>
          ...
          <p className="text-sm text-muted-foreground">{farmer.journey} · {farmer.region}</p>
        </FadeIn>
      </section>
      ...
      <section className="px-5 pb-8">
        <FadeIn>
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">{farmer.bio}</p>
        </FadeIn>
        <FadeIn delay={0.1}>
          <div className="bg-card rounded-2xl overflow-hidden shadow-card border border-border">
      ...
      <footer className="px-5 py-10 text-center bg-sage-light">
        <FadeIn>
          ...
          <p className="text-xs text-muted-foreground mt-1">Powered by TraceFarm</p>
        </FadeIn>
      </footer>
    </div>
  );
